			...
			$id	  = $_POST['id'];
				$Password = $_POST['Password'];
					...
					if(empty($id) or empty($Password)){
						...
						$login = $user->st_userlogin($id, $Password);
						if($login){
...
<html class="no-js" lang="">
	...
	<body >
			...
			<div class="secondthree">
					...
					<br>
						<img src="../img/std.png" width="20" height="20" align="middle"/><br> <br>
						 <form method="post" action="">
						<center>
							<table class="reg-table clear">
								<tr>
									<td>ID:</td>
									<td><input type="text" name="id" placeholder="" required autofocus/></td>
								</tr>
								<tr>
									<td>Password:</td>
