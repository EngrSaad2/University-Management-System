...
<div class="secondthree">
	...
	<div>
	<p style="float:left;margin:0 0 5px 0;width:84%;text-align:center;"><a href="view_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">View cgpa & completed course</button></a></p>
	</div>
